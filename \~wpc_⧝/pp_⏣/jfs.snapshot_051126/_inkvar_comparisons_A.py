...
""" BLOCK: Specials @ UFFF0-UFFFF:
	!
	FFF9:=interlinear annotation anchor;
	FFFA:=interlinear annotation separator;
	FFFB:=interlinear annotation terminator
	?
	xxFD:=object replacement character?
"""

""" BLOCK: General Punctuation @ U2000-U206F
	200B:=zero width space				ZWS
	...
	2062:=invisible times				wilder-cross
	2063:=invisible separator
	2064:=invisible plus				pi/4 cross
"""

"""
	BLOCK: Arabic Presentation Forms-B @ UFE70-UFEFF
	!
	FEFF:=zero width no-break space		ZWNBS
"""



""" __DEL:: reserved for bank switch array"""
...
""" VS & VS supplement block composition: ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
VSxXX, |VSxX0, |VSxX1, |VSxX2, |  ⋯ <-16B-> ⋯  |VSxXD, |VSxXE, |VSxXF, |
-------+-------|-------|-------|-------⋯-------|-------|-------|-------|
VSx2X  | ⋱
VSx3X  |
⋮  ⋮   ⋮
